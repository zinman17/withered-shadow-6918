...
const ROUTES = [
    ...
    ['GET', '/catalog', things.catalog],
    ['GET', '/colors', catalog.catalog],
    ['POST', '/colors', catalog.catalog],
    ['GET', '/item', things.item],
    ['POST', '/item', things.item],
    ['GET', '/item_new', things.itemNew],
    ['POST', '/item_new', things.itemNew],
    ['GET', '/download', things.download],
    ['GET', '/cloth_image', things.clothImage],
    ['GET', '/cloth_peer', things.clothPeer],
